 ...
 */(function() {
  ...
  var _getDOMObjectPosition = function(obj) {
    ...
    /*while (obj) {
      ...
      //对于fixed定位，上面代码就不准了，采用jQuery的方式(by hibincheng)
      var box = {
          left: 0,
          top: 0
      };
      ...
      info.top = box.top + scrollTop - clientTop;
      info.left = box.left + scrollLeft - clientLeft;
  ...
  ZeroClipboard.prototype.setCurrent = function(element) {
    ...
    if(this.isVersionSupport() === false) {
        return;
    }
    this.reposition();
  ...
  var _bridge = function() {
    ...
    if(client.flashBridge.length && client.flashBridge.length > 1) {
        client.flashBridge = client.flashBridge[1];
    }
    if(ZeroClipboard.IS_APPBOX) {
        _addEventHandler(container, 'mouseout', function(e) {
            currentElement && _removeClass(currentElement, client.options.hoverClass);
            client.resetBridge();
            enter_element = null;
            var func = client.handlers['mouseout'];
  ...
  ZeroClipboard.prototype.resetBridge = function() {
    ...
    currentElement && _removeClass(currentElement, this.options.activeClass);
    currentElement = null;
  ...
  //该插件在flash player 10以下用不了
  ZeroClipboard.prototype.isVersionSupport = function() {
      return this.versionSupport;
  };
  var enter_element;//用于appbox，判断是否不断解发 mouseover/mouseout
  ZeroClipboard.prototype.receiveEvent = function(eventName, args) {
    ...
    switch (eventName) {
     ...
     case "mouseover":
      ...
      break;
     case "mouseout":
         if(ZeroClipboard.IS_APPBOX) {//appbox会不断触发 mouseout/mouseover
  ...
  var WyZeroClipboard = ZeroClipboard;//增加引用，避免版本冲突
  if (typeof module !== "undefined") {
    module.exports = WyZeroClipboard;
  } else if (typeof define === "function" && define.amd) {
    define("club/weiyun/js/publics/plugins/ZeroClipboard/ZeroClipboard-1.1.7",[],function() {
      return WyZeroClipboard;
    });
  } else {
    window.WyZeroClipboard = WyZeroClipboard;
  }
})();