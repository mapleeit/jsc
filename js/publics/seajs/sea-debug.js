...
function request(url, callback, charset) {
  ...
  if (isCSS) {
    ...
    if (url.indexOf('imgcache.qq.com') > -1) {
...
Module.define = function (id, deps, factory) {
  ...
  // define("club/weiyun/js/publics/seajs/sea-debug",["id"],factory)
  if (argsLen === 1) {
    factory = id
    id = undefined
  }
    ...
    // define("club/weiyun/js/publics/seajs/sea-debug",["id"],deps, factory)
    if (isArray(id)) {
      deps = id
      id = undefined
    }
    // define("club/weiyun/js/publics/seajs/sea-debug",["id"],id, factory)
    else {
      deps = undefined
    }
  }
