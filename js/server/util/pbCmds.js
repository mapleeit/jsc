 ...
 */
    ...
    var cmds = {
        ...
        DiskRecycleDirFileClear         : 2710,     //批量彻底删除回收站内容
        ...
        WeiyunAdd10T            : 17006,    //领取10T
        WeiyunCheck10T          : 17007,    //检查是否已领取10T
        WeiyunActGetGoodsList   : 17020,    //拉取兑换奖品列表
        WeiyunActGetRedeemRecord: 17022,    //获取签到积分兑换记录
        WeiyunGetActStatus      : 17060,    //获取活动当前状态
        WeiyunActUserInfoCheckout: 17061,   //微云用户数据盘点活动(创建时间、容量、库相关信息、Tag相关信息、Note相关信息等）
        // 目录拷贝：   范围 18001--19000
