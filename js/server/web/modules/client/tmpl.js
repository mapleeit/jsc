...
//tmpl file list:
//client/src/async.tmpl.html
//client/src/bottom.tmpl.html
//client/src/header.tmpl.html
//client/src/login.tmpl.html
//client/src/main.tmpl.html
define("club/weiyun/js/server/web/modules/client/tmpl",["weiyun/conf/configs_css","weiyun/util/inline"],function(require, exports, module){
var tmpl = { 
'async': function(data){
...
__p.push('ipt type="text/javascript">\r\n\
    ...
    if(IS_APPBOX && (!window.external || !window.external.UploadFile) && !IS_DEBUG) {\r\n\
        location.href = \'http://www.weiyun.com/client/index.html?m=station\';\r\n\
    }\r\n\
</scr');
__p.push('ipt>\r\n\
\r\n\
...
__p.push('; }catch(e){ }; })(),\r\n\
    ...
    seajs.use([ \'$\', \'lib\', \'common\', \'station\'], function ($, lib, common, mod) {\r\n\
...
<body>\r\n\
    <p style="margin-top: 30px;margin-left: 20px">暂时无法进入中转站，请退出帐号再登录，或者反馈给我们</p>\r\n\
</body>\r\n\
</html>');
