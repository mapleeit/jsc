(function (win, seajs) {
    var
        ...
        js_base = res_host + '/club/weiyun/js-dist/appbox',
        ...
        file_list = {
            ...
            '@drag_files@': 'drag_files.r140710.js',
    ...
    // 微云JS模块配置
        alias = win.WY_SEAJS_ALIAS = {
            ...
            drag_files: 'module/drag_files/' + file_list['@drag_files@'],  // 拖拽文件（拖拽下载，拖拽发QQ文件入口）
            ...
            p_web_appbox_css: 'box/css-ver/' + css_list['@p_appbox_css@'],
            p_web_appbox_delay_css: 'box/css-ver/' + css_list['@p_appbox_delay_css@'],
            photo_guide_css: 'box/css/' + css_list['@photo_guide_css@'],
            offline_guide_css: 'box/css/' + css_list['@offline_guide_css@'],
            clipboard_css: 'box/css-ver/' + css_list['@appbox_clipboard_css@'],
