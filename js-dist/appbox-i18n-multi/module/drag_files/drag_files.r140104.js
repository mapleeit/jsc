...
define("club/weiyun/js-dist/appbox-i18n-multi/module/drag_files/drag_files.r140104",["lib","common"],function(require,exports,module){
 ...
 * @date 13-10-17
 */
define.pack("./drag_files",["lib","common"],function (require, exports, module) {
    var lib = require('lib'),
    ...
    var drag_files = {
        ...
        set_drag_files: function (files, e) {
            ...
            setTimeout(function () {
                try {
                    plugin_route.drag_files(select_file_object);
                }
                catch (e) {
