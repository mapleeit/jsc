...
define("club/weiyun/js-dist/appbox/module/outlink/outlink.r141216",["special_log","lib","common","$","qq_login","main"],function(require,exports,module){
    ...
    var ui = new Module('outlink_ui', {
        ...
        _render_outlink_content_ok: function(share_info) {
            ...
            if (share_flag == 2 || share_flag == 4) { //笔记外链
                ...
                if (1 == dir_list.length && 0 == file_list.length && ((dir_list[0].total_dir_count + dir_list[0].total_file_count) <= 100)) { //产品逻辑：当分享的只有一个文件夹且文件内文件总数<=100时，展示文件夹内文件，否则展示该文件夹
            ...
            if (!is_render_pic && !should_pwd) {
                //只对不需要密码的测速，直接展示外链内容，这样测速才准的，非图片在这样测，图片在图片加载完后测
        ...
        getShareList: function(dirList, fileList) {
            ...
            for (var j = 0; j < dirLen; j++) {
                ...
                shareList.push({
                    id: obj['dir_key'],
                    name: obj['dir_name'],
                    text: obj['total_file_count'] && obj['total_dir_count'] ? obj['total_file_count'] + obj['total_dir_count'] + '个文件' : '',
                    icon: 'folder'
                });
            }
        ...
        _render_outlink_note: function(share_info) {
            ...
            if (note_base_info.note_type == 1) {
                ...
                $share_body.find('[data-id=outlink_share_site_cnt]').html('<iframe src="' + artitle_info.note_artcile_url + '" frameborder="0" scrolling="no" width="100%" height="500px"/>');
            } else {
        ...
        _render_outlink_article: function(share_info) {
            ...
            $share_body.find('[data-id=outlink_share_name]').text(text.smart_cut(share_info.share_name, 40));
...
__p.push('    ');
    ...
    __p.push('    <div id="lay-main-con" class="lay-main-con">\r\n\
        <div class="inner">\r\n\
            <div class="wrap" style="height:835px;">\r\n\
...
__p.push('	');
        ...
        var msg = typeof message === 'string' ? message : message.msg;
    ...
    __p.push('    <div id="lay-main-con" class="lay-main-con">\r\n\
        <div class="inner">\r\n\
            <div class="wrap">\r\n\
                ...
                <div id="_disk_view" class="disk-view ui-view ui-thumbview" style="height:800px;overflow: auto; position: relative;">\r\n\
                    <!-- 文件列表 -->\r\n\
                    <!-- 目录 -->\r\n\
...
__p.push('" class="list-wrap share-file">\r\n\
                                    <div class="list clear">\r\n\
                                        ...
                                        <span class="img"><i class="filetype icon-');
_p(obj['icon']);
__p.push('"></i></span>\r\n\
...
__p.push('    ');
        ...
        picUrl = picUrl + (name.slice(-3) === 'gif' ? '' : '&size=640*640');
    __p.push('    <div class="link-pic share-file-list">\r\n\
        <table class="ui-selected" data-record-id="');
...
}__p.push('                <a class="g-btn g-btn-gray save-to-weiyun ');
if(!isSingleFile) {__p.push('g-btn-disabled');
                ...
                <a class="g-btn g-btn-gray" id="ui-btn-qr" href="javascript:void(0);">\r\n\
                    <span class="btn-inner download-by-qr">\r\n\
                        <i class="ico ico-qr"></i>\r\n\
                        <span class="text">二维码下载</span>\r\n\
                    </span>\r\n\
                </a>\r\n\
            </div>\r\n\
        </div>\r\n\
