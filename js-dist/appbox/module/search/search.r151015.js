...
define("club/weiyun/js-dist/appbox/module/search/search.r151015",["$","lib","common","main","disk","downloader"],function(require,exports,module){
 ...
 * @date 2013-9-11
 */
define.pack("./View",["lib","common","./tmpl","./Keyword_highlighter","downloader","$"],function(require, exports, module){
    var lib = require('lib'),
        inherit = lib.get('./inherit'),
        Event = lib.get('./Event'),
        text = lib.get('./text'),
...
__p.push('    ');
    ...
    __p.push('    <div class="lay-search-head" tabindex="0"><div class="inner"><div class="wrap">\r\n\
        <div class="infor1">搜索“');
_p(text.text(data.keyword));
__p.push('”:</div>\r\n\
        <div class="infor2">');
_p( data.searching ? '正在搜索...' : (data.count ? ('共'+data.count+'个') : '无结果') );
__p.push('</div>\r\n\
    </div></div></div>');
...
var __p=[],_p=function(s){__p.push(s)};
__p.push('    <div id="_search_body" class="disk-view ui-view ui-listview" data-label-for-aria="搜索结果内容区域">\r\n\
...
__p.push('>\r\n\
            ...
            <span class="img">');
 if(is_image){ __p.push('                    <i data-thumb class="filetype icon-image"></i>');
 }else{ __p.push('                    <i class="filetype ');
_p(icon_cls);
__p.push('"></i>');
 } __p.push('            </span>\r\n\
            <span class="name ellipsis"><p class="text">\r\n\
                <em tabindex="0" hidefocus="on"><s style="display:none;">文件</s>');
_p(highlight(name));
__p.push('</em>\r\n\
            </p></span>\r\n\
            <span class="tool">\r\n\
                <a class="link-openfold" title="打开文件所在目录" href="javascript:void(0);" data-action="open_folder" ');
_p(click_tj.make_tj_str('SEARCH_LIST_OPEN_FOLDER'));
__p.push('><i class="ico-openfold"></i></a>\r\n\
                <a class="link-share share_menu" title="分享" href="javascript:void(0);" data-action="share" ');
_p(click_tj.make_tj_str('SEARCH_LIST_SHARE'));
__p.push('><i class="ico-share" ></i></a>\r\n\
                <!--<a class="link-del" title="删除" href="javascript:void(0);" data-action="delete" ');
_p(click_tj.make_tj_str('SEARCH_LIST_DELETE'));
__p.push('><i class="ico-del"></i></a>-->\r\n\
                <a class="link-download" title="下载" href="javascript:void(0);" data-action="download" ');
...
__p.push('</span>');
if(!is_dir){__p.push('            <span class="dimensional" data-action="enter">\r\n\
