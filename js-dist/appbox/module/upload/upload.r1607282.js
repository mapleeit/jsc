...
define("club/weiyun/js-dist/appbox/module/upload/upload.r1607282",["lib","common","$","disk","main"],function(require,exports,module){
 ...
 * @date
 */
define.pack("./drag_upload_html5",["lib","common","$","disk","./upload_file_validata.upload_file_validata","./upload_route","./view","./Upload_class","./tool.upload_cache","./upload_folder.upload_folder_h5_start","main","./upload_html5_pro_class","./upload_html5_pro","./Upload_h5_flash_class","./upload_h5_flash","./Upload_html5_class","./upload_html5"],function(require, exports, module) {
...
//        }
		...
		dropbox.addEventListener("drop", function(e) {
			...
			functional.burst(files, function(file) {
				...
				} else if(upload_route.is_support_flash()) {
					//yuyanghe 托拽上传. 加入优先选择FLASH 秒传 其次是html5的逻辑.
					upload_obj = require('./Upload_h5_flash_class').getInstance(require("./upload_h5_flash"), random.random(), file, attrs);
					upload_obj.upload_type = 'upload_h5_flash';
		...
		setTimeout(function() {
			if(!upload_route.is_support_html5_pro() && upload_route.is_support_flash() && upload_route.type !== 'upload_h5_flash') {
...
define.pack("./event",["$","./upload_route","./tool.upload_cache","lib","common","./tool.upload_static"],function(require, exports, module) {
	var $ = require('$'),
		upload_route = require('./upload_route'),
		upload_cache = require('./tool.upload_cache'),
...
});define.pack("./tool.bar_info",["$","lib","common","./tool.upload_cache","./tool.upload_static","./speed.speed_task","./upload_route","./tool.temporary_upload","./view"],function (require, exports, module) {
    var $ = require('$'),
	    lib = require('lib'),
	    common = require('common'),
    ...
    return {
        ...
        get_close_btn_text: function(){
            ...
            if( up.length === up.error + up.pause + up.done
                ...
                return '<span class="btn-inner">完成</span>';
            if( up.length + dw.length > 1)
                return '<span class="btn-inner">全部取消</span>';
            return '<span class="btn-inner">全部取消</span>';
        },
        /**
         * 是否初始化
 ...
 * Time: 下午3:53
 */
define.pack("./tool.upload_static",["lib","common","$","./tool.upload_cache","./speed.speed_task","./msg","disk","./view","./tool.bar_info"],function (require, exports, module) {
    var console = require('lib').get('./console'),
        common = require('common'),
        $ = require('$'),
...
});define.pack("./upload_flash_start",["lib","common","$","./upload_route","./Upload_class","./select_folder.select_folder","./tool.upload_static","./tool.upload_cache","./upload_file_validata.upload_file_validata","./view","disk","main"],function (require, exports, module) {
 ...
 * 上传文件夹 by trump
 */
define.pack("./upload_folder.upload_folder_h5",["$","lib","common","./msg","./view","disk","./Upload_class","./upload_route","./tool.bar_info","./tool.upload_static","./tool.upload_cache","./upload_html5_pro_class","./Upload_h5_flash_class","./Upload_html5_class"],function(require, exports, module) {
		...
		get_sub_class = function() {
			if(!sub_class) {
				if(upload_route.is_support_html5_pro() && query.upload !== 'plugin') {
					...
					sub_class = require('./Upload_h5_flash_class');
				} else {
 ...
 * @date 2015-01-16
 */
define.pack("./upload_folder.upload_folder_h5_start",["lib","common","$","./upload_folder.TreeNode","./upload_file_validata.upload_folder_validata","./upload_folder.Create_dirs_class","./upload_route","disk","./upload_folder.loading","./select_folder.select_folder","./tmpl","./upload_html5_pro","./upload_h5_flash","./upload_html5"],function(require, exports, module) {
    var lib = require('lib'),
        common = require('common'),
        $ = require('$'),
 ...
 * HTML5上传
 */
define.pack("./upload_h5_flash",["lib","common","$","./upload_route","./select_folder.select_folder","./file_exif","main","./tool.upload_cache","./Upload_html5_class","./upload_html5"],function(require, exports, module) {
...
});define.pack("./upload_h5_flash_start",["lib","common","$","./upload_route","./Upload_class","./select_folder.select_folder","./tool.upload_static","./tool.upload_cache","./view","./upload_file_validata.upload_file_validata","disk","./select_folder.photo_group","./Upload_h5_flash_class"],function (require, exports, module) {
 ...
 * 多线程HTML5上传
 */
define.pack("./upload_html5_pro",["$","lib","common","main","./upload_route","./tool.upload_static","./select_folder.select_folder","./file_exif"],function(require, exports, module) {
	//基础库
	var $ = require('$'),
		lib = require('lib'),
		common = require('common'),
...
define.pack("./upload_plugin.upload_plugin",["lib","common","$","./view","./Upload_class","./msg","./upload_route","./upload_file_validata.upload_file_validata","./tool.upload_static","./tool.upload_cache","disk"],function (require, exports, module) {
...
define.pack("./upload_plugin_start",["lib","common","$","./upload_route","./upload_plugin.upload_plugin","./upload_plugin.upload_plugin_folder","./upload_folder.get_up_folder_files","./upload_file_validata.upload_folder_validata","./upload_file_validata.upload_file_check","./select_folder.select_folder","./tmpl","disk","./upload_folder.loading","./upload_folder.upload_folder_appbox","./upload_folder.upload_folder_ie","./upload_files.upload_files_webkit","./upload_files.upload_files_ie"],function (require, exports, module) {
    ...
    var lib = require('lib'),
        ...
        compare_plugin_ver = function (ie_ver, webkit_ver) {
            ...
            if(upload_route.type === 'webkit_plugin'){
                var ver = plugin_detect.get_webkit_plugin_version(),
                    cur_ver = parseInt(ver.split('.').join(''), 10);
                if(cur_ver < webkit_ver){
                    return false;
                }
                return true;
            }
            else{
                var ver = plugin_detect.get_ie_plugin_version(),
                    cur_ver = parseInt(ver.split('.').join(''), 10);
                if(cur_ver < ie_ver){
                    return false;
                }
    ...
    var start_upload = function (upload_plugin) {    //用户通过选择框上传
        ...
        if( is_support_gt3000_files() ){
            if(upload_route.type === 'webkit_plugin'){
                ...
                var taskId = upload_plugin.SelectFilesAsyncCallback(window);
            }
            else{
                var taskId = upload_plugin.AsyncSelectFiles(window, '');
...
define.pack("./upload_route",["$","lib","common","./tmpl","main","./tool.upload_cache","./upload_global_function","./Upload_class","./upload_plugin_start","./drag_upload_active","./upload_flash_start","./upload_form_start","./upload_html5_start","./upload_html5","./upload_html5_pro_class","./upload_html5_pro","./upload_h5_flash","./upload_h5_flash_start","./drag_upload_html5","./upload_dropdown_menu","./upload_folder.upload_folder_h5_start"],function(require, exports, module) {
	//基础库
	var $ = require('$'),
		lib = require('lib'),
		common = require('common'),
 ...
 * @date 13-3-1
 */
define.pack("./view",["lib","common","$","main","./upload_route","./tmpl","./upload_tips","./tool.upload_static","./tool.upload_cache","./event","./tool.bar_info","./view_type.empty","./view_type.folder","./view_type.webkit_down"],function (require, exports, module) {
...
__p.push('    <div class="check-group" style="display:none;cursor: pointer;width:80px;"><i data-id="upload_group_check" class="checkbox"></i>指定分组\r\n\
    </div>');
...
__p.push('    ');
    ...
    if(!upload_route.is_ku20()){//todo ku20
        dir_name = dir_name == '微云' ? '网盘' : dir_name;
        no_cursor = '';
    }
...
__p.push('</span>\r\n\
    ...
    __p.push('    <li id="_file_box_node_-1" data-file-id="-1" data-file-pid="-1" data-level="0" data-dir-name="相册">\r\n\
        <a href="#" hidefocus="on" style="padding-left:0px;">\r\n\
            <span class="ui-text" id="album"><i></i>相册</span>\r\n\
        </a>\r\n\
    </li>');
...
_p((data.icon_err?data.icon_err:'上传失败'));
__p.push('"></i>\r\n\
...
__p.push('"><a href="javascript:void(0)" tabindex="-1">');
_p(data.file_dir);
__p.push('</a></div>\r\n\
...
__p.push('    ');
        ...
        var common = require('common'),
            ...
            lib = require('lib'),
            text = lib.get('./text');
    __p.push('    <h3 class="ui-title">有<strong>');
_p(data.length);
__p.push('</strong>个文件上传失败</h3>\r\n\
                \r\n\
...
__p.push('	');
    ...
    var lib = require('lib'),
        common = require('common'),
        click_tj = common.get('./configs.click_tj');
    __p.push('    <a class="g-btn g-btn-blue" href="#" hidefocus="on" tabindex="-1" ');
...
__p.push('	');
    ...
    var lib = require('lib'),
        common = require('common'),
        click_tj = common.get('./configs.click_tj');
    __p.push('        <!--<a href="#" id="upload_dropdown_inner" data-action="upload_files" class="btn" hidefocus="on" title="上传文件" ');
_p(click_tj.make_tj_str('UPLOAD_SELECT_FILE'));
__p.push('>\r\n\
