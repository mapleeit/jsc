...
define("club/weiyun/js-dist/appbox/module/indep_login/indep_login.r141016",["lib","common","$","to_singin_css","main"],function(require,exports,module){
 ...
 * @date 13-3-25
 */
define.pack("./ui",["to_singin_css","lib","common","$","./tmpl","main","./indep_login"],function (require, exports, module) {
...
__p.push(')</span>');
                        ...
                        <div class="ui-passwords">\r\n\
                            <label class="ui-text-defult" for="_indep_login_pwd">请输入您的独立密码</label>\r\n\
                    ...
                    <div class="ui-form-item  to-signin-btn">\r\n\
                        <a href="');
_p(forget_pwd_url);
__p.push('" target="_blank">忘记密码？</a>');
 if (!constants.IS_APPBOX && !constants.IS_WRAPPED) { __p.push('                        <a data-action="change-account" href="#">更换帐号</a>');
 } __p.push('                        <a data-action="ok" class="g-btn g-btn-blue" href="#"><span class="btn-inner medium">确定</span></a>\r\n\
                    </div>\r\n\
                </div>\r\n\
            </div>\r\n\
    </div>');
...
__p.push('    <div data-no-selection class="to-signin-box error">\r\n\
        <div class="to-signin-head" tabindex="0"><h3><span class="warn"></span>验证独立密码失败</h3></div>\r\n\
        <div class="to-signin-body to-signin" style="min-height: 100px;">\r\n\
            <div class="ui-form">\r\n\
                <div class="ui-form-item" tabindex="0">\r\n\
                    <p data-id="-err-msg" class="ui-tips ui-tips-err">\r\n\
                        验证独立密码过程中出现错误<br>如果您从未设置过独立密码，请尝试\r\n\
