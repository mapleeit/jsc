...
define("club/weiyun/js-dist/appbox/module/share/share.r150609",["lib","common","$","main"],function(require,exports,module){
...
__p.push('    <div class="inner">\r\n\
        <div class="share-top">\r\n\
            <div class="head" id=\'share_head\'>\r\n\
                <h2 class="title">分享的链接</h2>\r\n\
                <p class="con" data-id="share_count_ct" style="display:none;"><span data-id="public_count"></span>个公开分享&nbsp;&nbsp;<span data-id="private_count"></span>个私密分享</p>\r\n\
            </div>\r\n\
            <!--<div class="infor">微云分享链接，不限下载次数，永久有效！</div>-->\r\n\
        </div>\r\n\
    </div>');
...
var __p=[],_p=function(s){__p.push(s)};
__p.push('    <div><p data-id="share_count_ct" style="display:none;"><span data-id="public_count"></span>个公开分享&nbsp;&nbsp;<span data-id="private_count"></span>个私密分享</p></div>');
...
__p.push('    <!-- update jin 20130731 -->\r\n\
    ...
    <div id="_share_toolbar" class="toolbar-btn clear share-toolbar" style="display:none">\r\n\
        <div class="btn-message">\r\n\
            <a class="g-btn g-btn-gray" href="#" data-no-selection data-action="bat_cancel_share" tabindex="-1"><span class="btn-inner"><i class="ico ico-kill-share"></i><span class="text">取消分享</span></span></a>\r\n\
            <a data-action="refresh" class="g-btn g-btn-gray" href="#"  tabindex="-1"><span class="btn-inner minpad"><i class="ico ico-ref"></i><span class="text"></span></span></a>\r\n\
        </div>\r\n\
    </div>');
...
__p.push('    <!-- update jin 20130731 -->\r\n\
    ...
    <div id="_share_toolbar" class="toolbar-btn clear share-toolbar" style="display:none">\r\n\
        <div class="btn-message">\r\n\
            <a class="g-btn g-btn-gray" href="#" data-no-selection data-action="bat_cancel_share" tabindex="-1"><span class="btn-inner"><i class="ico ico-kill-share"></i><span class="text">取消分享</span></span></a>\r\n\
            <a data-action="refresh" class="g-btn g-btn-gray" href="#"  tabindex="-1"><span class="btn-inner"><i class="ico ico-ref"></i><span class="text"></span></span></a>\r\n\
        </div>\r\n\
        <div class="infor share-infor-ct" data-id="share_count_ct"></div>\r\n\
        <div data-id="share_info_empty" class="infor share-infor-empty" tabindex="0">暂无分享</div>\r\n\
    </div>');
...
__p.push('        <div class="inner" style="display:none">\r\n\
            <div class="share-head">\r\n\
                <!-- list-hover 为ie6下hover样式 -->\r\n\
                    ...
                    <span class="list status"><span class="wrap"><span class="inner">状态<i class="gap"></i>\r\n\
                    </span></span></span>\r\n\
                    <span class="list time"><span class="wrap"><span class="inner">\r\n\
                        分享时间<i class="gap"></i>\r\n\
                    </span></span></span>\r\n\
                    <span class="list remain"><span class="wrap"><span class="inner">\r\n\
                        剩余时间<i class="gap"></i>\r\n\
                    </span></span></span>\r\n\
        ...
        <div class="full-pop-content __content">\r\n\
            ...
            <div data-id="change_content" class="popshare-box popshare-pass-manage" style="display:none;">\r\n\
                <div class="change">\r\n\
                    ...
                    <div class="edit buf-password"><i data-id="change_pwd_check" class="ico ico-checked"></i><span data-id="change_pwd_check_tip">修改密码</span><input style="ime-mode:disabled" name="change_pwd_text" data-id="change_pwd_text" type="text" maxlength="4" value=""></div>\r\n\
                </div>\r\n\
            </div>\r\n\
            <!--成功content-->\r\n\
...
var __p=[],_p=function(s){__p.push(s)};
__p.push('    <div id="_share_body"  class="disk-view ui-view ui-listview disk-share" data-label-for-aria="分享的链接内容区域">\r\n\
...
__p.push('</span></em></p></span>\r\n\
                <span class="tool"><span class="inner">\r\n\
                   ...
                   __p.push('                        ');
 if(!is_note) { __p.push('                            ');
 if(!file.get('share_pwd')) {__p.push('                                <a data-action="create_pwd" class="link-lock" title="创建访问密码" href="#" tabindex="-1"><i class="ico-kill-lock"></i></a>');
} else { __p.push('                                <a data-action="manage_pwd" class="link-lock" title="密码管理" href="#" tabindex="-1"><i class="ico-lock"></i></a>');
 } __p.push('                        ');
 } __p.push('                        ');
 if(Copy.can_copy()) { __p.push('                            <a data-clipboard-target data-action="copy_share" class="link-copy" title="复制分享链接" href="#" tabindex="-1"><i class="ico-copy"></i></a>');
 } __p.push('                        <a data-action="view_share" class="link-link" title="访问分享链接" href="#" tabindex="0"><i class="ico-link"></i></a>');
 } __p.push('                </span></span>');

            if(!is_dirty) {
            __p.push('            <span class="status" tabindex="0"><span class="inner">');
_p(read_mode ? '状态：' : '');
...
__p.push('</span></span>');
            ...
            __p.push('            <span class="status" tabindex="0"><span class="inner">');
_p(read_mode ? '状态：' : '');
_p(file.get('share_pwd') ?'私密' : '公开' );
__p.push('</span></span>');

            }
            __p.push('            <span class="time" tabindex="0"><span class="inner">');
_p(read_mode ? '分享时间：' : '');
_p(getTimeFormat(file.get('create_time')));
__p.push('</span></span>\r\n\
            <span class="remain" tabindex="0"><span class="inner">');
_p(read_mode ? '剩余时间：' : '');
_p(getRemainTimeFormat(file.get('remain_time')));
__p.push('</span></span>\r\n\
            <span class="view" tabindex="0"><span class="inner">');
_p(read_mode ? '被浏览次数：' : '');
_p(file.get('view_cnt')>=0?file.get('view_cnt'):'-');
__p.push('</span></span>\r\n\
            <span class="download" tabindex="0"><span class="inner">');
_p(read_mode ? '被下载次数：' : '');
...
__p.push('</span></span>\r\n\
            <div class="more">');
                ...
                if(is_normal){
                __p.push('\r\n\
                <label>链接：</label><a data-action="view_share" ');
_p(click_tj.make_tj_str('SHARE_ITEM_CLICK'));
__p.push('  href="#" target="_blank" tabindex="-1">');
_p(file.get('raw_url'));
__p.push('</a>');
 if(file.get('share_pwd')) { __p.push('                <label>访问密码：</label><em data-id="share_pwd">');
_p(file.get('share_pwd'));
__p.push('</em>');
 } __p.push('                ');
 if(Copy.can_copy()) { __p.push('                    <a data-clipboard-target data-action="copy_share" class="g-btn g-btn-gray" href="#" title="复制" tabindex="-1"><span class="btn-inner"><i class="ico ico-copy"></i><span class="text">复制</span></span></a>');
 } 
                } else if(is_dirty) {
                __p.push('                <label tabindex="0">链接信息获取失败</label>');
 }else if(is_illegalReport){ __p.push('                <label tabindex="0">该外链因侵犯他人利益，已失效</label>');

                }else if(is_expire){
                __p.push('                <label tabindex="0">链接已过期</label>');

                }else if(is_used){
                __p.push('                <label tabindex="0">外链使用次数已用完</label>');

                }else { __p.push('                <label tabindex="0">文件已被删除</label>');
 } __p.push('            </div>');

            /* for 读屏软件 - james */
            if (read_mode) { __p.push('                <input data-action="fill_url_for_aria" title="按下Ctrl加C复制该链接" tabindex="0" style="width:10px;" value="');
_p(text.text(file.get('short_url')));
__p.push('" readonly="readonly"/>');
 } __p.push('        </div>');
