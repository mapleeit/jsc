...
define("club/weiyun/js-dist/appbox/module/recent/recent.r151015",["lib","common","$","main"],function(require,exports,module){
    ...
    var ui = new Module('recent_ui', {
        ...
        _render_thumb: function() {
            ...
            this.get_thumb_loader().done(function(thumb_loader) {
                me._get_data_wraper().find('i[data-init=0]').each(function (i, n) {
...
__p.push('    <div id="_recent_files_empty" class="g-empty sort-recent-empty">\r\n\
...
__p.push('</em></p>\r\n\
            ...
            <span class="tool">\r\n\
                <a class="link-download" data-function="download" data-tj-action="btn-adtag-tj" data-tj-value="57001" title="下载" aria-label="');
_p(text_name);
__p.push('" tabindex="0" hidefocus="on" href="#"><i class="ico-download"></i></a>\r\n\
            </span>');
...
_p(read_mode?'时间：':'');
_p(scr_reader_mode.readable_time(file._html_time));
__p.push('</div>');
...
_p(file._html_time);
__p.push('</span>');
 }__p.push('            <span class="dimensional" data-action="enter">\r\n\
...
var __p=[],_p=function(s){__p.push(s)};
__p.push('    <div id="_recent_body" class="disk-view ui-view ui-listview" data-label-for-aria="最近文件列表内容区域">\r\n\
...
var __p=[],_p=function(s){__p.push(s)};
__p.push('    <h3 class="disk-title"><div tabindex="0">');
