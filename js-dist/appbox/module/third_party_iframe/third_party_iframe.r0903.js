...
define("club/weiyun/js-dist/appbox/module/third_party_iframe/third_party_iframe.r0903",["lib","common","$"],function(require,exports,module){
...
__p.push('    <div data-name="loading" class="viewer-init" style="display: none;">\r\n\
        ...
        <p class="ui-quota-text">\r\n\
            <span data-name="loading-text">在加载中，请稍候</span>\r\n\
            <span>...</span>\r\n\
        </p>\r\n\
    </div>');
