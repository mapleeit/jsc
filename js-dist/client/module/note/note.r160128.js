...
define("club/weiyun/js-dist/client/module/note/note.r160128",["lib","common","$","note_css"],function(require,exports,module){
 ...
 * @date 2014-12-20
 */
define.pack("./Module",["$","lib"],function(require, exports, module) {
	var $ = require('$'),
		lib = require('lib'),
 ...
 * To change this template use File | Settings | File Templates.
 */
define.pack("./View",["lib","common","./tmpl"],function(require, exports, module) {
	var lib = require('lib'),
		common = require('common'),
...
define.pack("./header.Toolbar",["lib","common","$","./tmpl"],function(require, exports, module){
    ...
    var Toolbar = inherit(Event, {
        is_debug: false, //测试PC登录态维持，默认为false

        render: function($ct) {
            if(!this.rendered) {
                this.$el = $(tmpl['note_toolbar']({is_debug: this.is_debug})).appendTo($ct);
                this.bind_action();
                this.rendered = true;
            }
        },
...
define.pack("./note",["lib","common","$","./Module","./Loader","./View","./header.Toolbar","./Mgr","note_css"],function(require, exports, module) { //noinspection JSValidateTypes,JSValidateTypes
	var lib = require('lib'),
		common = require('common'),
		$ = require('$');
...
if(data.is_debug) { __p.push('            <a data-no-selection data-action="clear" class="g-btn g-btn-gray" href="#" tabindex="-1"><span class="btn-inner"><i class="ico ico-del"></i><span class="text">清除</span></span></a>');
 } __p.push('            <a data-no-selection data-action="refresh" class="g-btn g-btn-gray" href="#" tabindex="-1"><span class="btn-inner minpad"><i class="ico ico-ref"></i><span class="text"></span></span></a>\r\n\
        </div>\r\n\
    </div>');
...
var __p=[],_p=function(s){__p.push(s)};
with(data||{}){
__p.push('    <div class="g-empty sort-note-empty">\r\n\
