...
define(["lib","common","$","webbase_css","disk_css","downloader"],function(require,exports,module){
 ...
 */
define.pack("./view",["webbase_css","disk_css","lib","common","$","./request","downloader","./tmpl"],function (require, exports, module) {
...
__p.push('    <div data-name="error" class="viewer-tips" style="">\r\n\
        <div class="ui-tips">\r\n\
            ...
            <p class="ui-text">拉取数据时发生错误，请<a data-action="retry" href="#">重试</a>或直接<a data-action="down" href="#">下载</a></p>\r\n\
        </div>\r\n\
    </div>');
