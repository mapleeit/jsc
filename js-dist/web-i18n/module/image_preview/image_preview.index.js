 ...
 * @date 13-5-7
 */
define.pack("./image_preview",["lib","common","i18n","$","./tmpl"],function (require, exports, module) {
    var lib = require('lib'),
    ...
    var image_preview = {
        ...
        start: function (o) {
            ...
            // 遮罩
            widgets.mask.show('image_previewer', $el);
        ...
        _step: function (is_forward, is_nav) {
            ...
            while (true) {
                to_index = math.max(0, math.min(to_index + step, o.total - 1));
//                if (to_index === o.index) {
//                    return this.close();
//                }
                ...
                if ($.isFunction(o.get_url)) {
                    ...
                    // 已到达边界，不执行任何动作，退出
                    else if ((!is_forward && to_index === 0) || (is_forward && to_index === o.total - 1)) {
                        break;
                    }
                }
        ...
        _update_status: function () {
            ...
            if (o.support_nav) {
                ...
                var has_next = o.index < o.total - 1 && (!o.has_next || o.has_next.call(this, o));
                ...
                // 页码
                $info.text(_('第{0}/{1}张', o.index + 1, o.total));
            }
            ...
            if (options.support_nav) {
                ...
                $(document).on('keyup.image_preview', function (e) {
                    ...
                    switch (e.which) {
                        ...
                        // 右光标键，厚一张
                        case 39:
                            var has_next = options.index < options.total - 1;
...
__p.push('    ');
 var _ = require('i18n'); __p.push('    <div data-no-selection class="viewer">\r\n\
