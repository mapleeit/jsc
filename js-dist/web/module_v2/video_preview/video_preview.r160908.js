...
define("club/weiyun/js-dist/web/module_v2/video_preview/video_preview.r160908",["lib","common","$"],function(require,exports,module){
...
//all file list:
//video_preview/src/dom.js
//video_preview/src/file/cgi2file.js
//video_preview/src/library/video.js
//video_preview/src/loader.js
//video_preview/src/login.js
//video_preview/src/url/get_real_down_url.js
//video_preview/src/video_controller.js
//video_preview/src/video_episode.js
//video_preview/src/video_plugin/bottom_mask.js
//video_preview/src/video_plugin/dbclick_fullscreen.js
//video_preview/src/video_plugin/replay_when_ended.js
//video_preview/src/video_plugin/top_title.js
//video_preview/src/video_plugin/volume_percent_display.js
//video_preview/src/video_preview.js
//video_preview/src/episode_li.tmpl.html
...
define.pack("./dom",[],function (require, exports, module) {
    return {
        /**
         * get download btn
...
define.pack("./file.cgi2file",["lib","common","$"],function(require, exports, module){
    var lib = require('lib'),
...
(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define("club/weiyun/js-dist/web/module_v2/video_preview/video_preview.r160908",[],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.videojs = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(_dereq_,module,exports){
'use strict';
...
define.pack("./url.get_real_down_url",["lib","common","$"],function(require, exports, module){
    var lib = require('lib'),
        common = require('common'),
        $ = require('$'),
...
define.pack("./video_controller",["lib","common","$","./dom","./library.video","./video_plugin.volume_percent_display","./video_plugin.top_title","./video_plugin.bottom_mask","./video_plugin.dbclick_fullscreen","./video_plugin.replay_when_ended"],function (require, exports, module) {
    var lib = require('lib'),
        common = require('common'),
        $ = require('$');
...
define.pack("./video_episode",["lib","common","$","./loader","./file.cgi2file","./tmpl","./url.get_real_down_url","./login","./dom"],function(require, exports, module){
    var lib = require('lib'),
        common = require('common'),
        $ = require('$');
...
define.pack("./video_preview",["lib","common","$","./video_controller","./video_episode","./file.cgi2file","./url.get_real_down_url","./login","./dom"],function(require, exports, module){
    var lib = require('lib'),
        common = require('common'),
        $ = require('$');
...
var tmpl = { 
'episode_li': function(data){

var __p=[],_p=function(s){__p.push(s)};
with(data||{}){
__p.push('    <li class="video-list-item j-video-list-item" data-video-index="');
_p(data.videoIndex);
