...
define("club/weiyun/js-dist/web/module_v2/categories/categories.r151223",["$","lib","common","main"],function(require,exports,module){
    ...
    var Category_file = inherit(File, {
        constructor : function(cfg){
            ...
            if(cfg.ext_info && cfg.ext_info.thumb_url) {
                this.thumb_url = cfg.ext_info.thumb_url;//缩略图，视频类有用到
        ...
        on_open : function(records, e, extra){
            ...
            if (record.is_video()) {
                window.open('//www.weiyun.com/video_preview?' +
                    'videoID=' + record.get_id() +
                    '&dirKey=' + record.get_pid() +
...
__p.push('    <div class="view-item-list clearfix">\r\n\
        <div id="view-mode-sort" class="view-item clearfix item-doctype">\r\n\
            <a data-action="filter" data-filter="all" class="item-list" href="#" title="">全部</a>\r\n\
            <a data-action="filter" data-filter="word" class="item-list" href="#" title="">DOC</a>\r\n\
            <a data-action="filter" data-filter="excel" class="item-list" href="#" title="">XLS</a>\r\n\
            <a data-action="filter" data-filter="ppt" class="item-list" href="#" title="">PPT</a>\r\n\
            <a data-action="filter" data-filter="pdf" class="item-list" href="#" title="">PDF</a>\r\n\
        </div>\r\n\
    </div>');
...
var __p=[],_p=function(s){__p.push(s)};
__p.push('    <div id="_doc_body" class="mod-list-group" data-label-for-aria="文档列表内容区域">\r\n\
...
__p.push('    ');
    ...
    var lib = require('lib'),
        ...
        id_perfix = data.id_perfix || 'doc-item-',
        files = data.files,
